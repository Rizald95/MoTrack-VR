...
public class ObjGameAnchorManager : MonoBehaviour
{
    [Header("Game Components")]
    [SerializeField]
    private GameObject dronePreview;//rightGrip
    [SerializeField]
    private GameObject dronePrefab;//rightGrip
